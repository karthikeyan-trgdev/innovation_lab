                ...
                <div class="tab-content individual-segment">
                    ...
                    <div class="tab-pane container active" id="home">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="card quiz_card">
                                    <a type="button" data-bs-toggle="modal" data-bs-target="#magnetometer">
                                        <div class="image">
                                            <img src="assets/images/quiz/plasma-wave-quiz-thumb.png" alt="" />
                                        </div>
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="card quiz_card">
                                    <a type="button" data-bs-toggle="modal" data-bs-target="#plasma">
                                        <div class="image">
                                            <img src="assets/images/quiz/magnetometer-quiz-thumb.png"
                                                alt="" />
                                        </div>
                                    </a>
                                </div>
...
<!-- The Modal -->
<div class="modal segment-popup" id="magnetometer">
...
<div class="modal segment-popup" id="plasma">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
...
<script>
    $(document).ready(function () {
        ...
        const quizStates = {
            'magnetometer': { score: 0, answered: 0 },
            'plasma': { score: 0, answered: 0 }
        };
        ...
        $('#magnetometer, #plasma').on('hidden.bs.modal', function () {
        ...
        $('#magnetometer, #plasma').modal({
            backdrop: 'static',
            keyboard: false
        });

        // Initialize Owl Carousel for all modals
        $('#magnetometer, #plasma').on('shown.bs.modal', function () {
