                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="card quiz_card">
                                    <a type="button" data-bs-toggle="modal" data-bs-target="#cybermax">
                                        <div class="image">
                                            <img src="assets/images/quiz/cybermax-quiz-thumb.png" alt="" />
                                        </div>
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="card quiz_card">
                                    <a type="button" data-bs-toggle="modal" data-bs-target="#cosmic">
                                        <div class="image">
                                            <img src="assets/images/quiz/cosmic-quiz-thumb.png"
                                                alt="" />
                                        </div>
                                    </a>
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="card quiz_card">
                                    <a type="button" data-bs-toggle="modal" data-bs-target="#universal">
                                        <div class="image">
                                            <img src="assets/images/quiz/universal-quiz-thumb.png" alt="" />
                                        </div>
                                    </a>
                                </div>
                            </div>
...
<!-- The Modal -->
<div class="modal segment-popup" id="cybermax">
...
<div class="modal segment-popup" id="cosmic">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
                    ...
                    <div class="item" style="padding:0px;border-radius:20px">
                        <div class="quiz-container">
                            <div class="quiz-header-bar">
                                <div class="quiz-question-box">
                                    <span class="quiz-question-text">
                                        cosmic Which innovation allows doctors to look inside the human body without surgery?
                                    </span>
                                </div>
                                <div class="icon-atom">
                                    <img src="assets/images/quiz/quiz-icon-3.png" alt="">
...
<div class="modal segment-popup" id="universal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
...
<script>
    $(document).ready(function () {
        ...
        const quizStates = {
            'cybermax': { score: 0, answered: 0 },
            'cosmic': { score: 0, answered: 0 },
            'universal': { score: 0, answered: 0 }
        };
        ...
        $('#cybermax, #cosmic, #universal').on('hidden.bs.modal', function () {
        ...
        $('#cybermax, #cosmic, #universal').modal({
            backdrop: 'static',
            keyboard: false
        });

        // Initialize Owl Carousel for all modals
        $('#cybermax, #cosmic, #universal').on('shown.bs.modal', function () {
